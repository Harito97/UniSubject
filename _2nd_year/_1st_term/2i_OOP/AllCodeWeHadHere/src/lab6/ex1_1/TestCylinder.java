...
public class TestCylinder {
    public static void main(String[] args) {
        ...
        //Test toString() cua Cylinder
        System.out.println();
        System.out.println(cy1.toString() + ", the Area: " +  cy1.getArea() + ", the Volume: " + cy1.getVolume());
        System.out.println(cy2.toString() + ", the Area: " +  cy2.getArea() + ", the Volume: " + cy2.getVolume());
    }
}
