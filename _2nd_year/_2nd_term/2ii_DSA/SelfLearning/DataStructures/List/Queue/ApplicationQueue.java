...
import DataStructureAndAlgorithms.SelfLearning.DataStructures.List.CircularlyLinkedList.CircularlyLinkedList;

// Trò chơi Josephus dùng để loại dần người chơi theo vòng tròn
public class ApplicationQueue {
    ...
    public static <E> CircularQueue<E> buildQueue(E a[ ]) {
        CircularQueue<E> queue = new CircularlyLinkedList<>( );
